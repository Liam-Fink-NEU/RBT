...
(function (global, factory) {
	module.exports = factory(require$$0, propTypes, React__default);
}(commonjsGlobal, (function (fontawesome,PropTypes,React$$1) { fontawesome = fontawesome && fontawesome.hasOwnProperty('default') ? fontawesome['default'] : fontawesome;
...
var Button = function (_Component) {
	...
	createClass$1(Button, [{
		...
		value: function render() {
			var classes = ["button", this.props.classes].join(" ");
			var disabled = this.props.loading === true;
			return React__default.createElement(
				'button',
				{ style: this.props.style, disabled: disabled, className: classes, onClick: this.props.onClick, type: this.props.type || 'button' },
				disabled && React__default.createElement(reactFontawesome, { className: 'fa-spin', icon: faCircleNotch }),
...
var Card = function (_Component) {
	...
	createClass$1(Card, [{
		key: 'render',
		value: function render() {
			var classes = ["card", this.props.classes ? this.props.classes : "", this.props.state ? this.props.state : ""].join(" ");

			var card;

			if (this.props.to) {
				card = React__default.createElement(
					reactRouterDom.NavLink,
					{ to: this.props.to, className: classes },
					React__default.createElement(
						'div',
						{ className: 'card-content' },
						this.props.children
					),
					this.props.footer && React__default.createElement(
						'div',
				...
				card = React__default.createElement(
					'div',
					{ className: classes, onClick: this.props.onClick, id: this.props.id || "" },
					React__default.createElement(
						'div',
...
var Dropdown = function (_Component) {
	...
	function Dropdown(props) {
		...
		_this.handleClickOutside = function (event) {
			if (_this.wrapperRef && !_this.wrapperRef.contains(event.target)) {
				if (_this.state.isOpen && !_this.state.disableClickClose) _this.setState({ isOpen: false });
			}
		};
		...
		_this.state = {
			isOpen: false,
			showIcon: _this.props.showIcon === true,
			disableClickClose: _this.props.disableClickClose
		};
		return _this;
	}
	...
	createClass$1(Dropdown, [{
		...
		value: function render() {
			...
			var icon = this.state.isOpen ? faChevronUp : faChevronDown;

			var classes = ["dropdown", this.props.classes].join(" ");
			var itemClasses = ["dropdown-items", show].join(" ");
			var buttonClasses = ["full-width", this.props.buttonClasses].join(" ");
			var styles = {
				"width": width + "px"
			};
			...
			return React__default.createElement(
				...
				React__default.createElement(
					Button,
					{ classes: buttonClasses + " " + (this.props.type || ""), style: this.props.buttonStyle, onClick: this.toggle },
					this.props.buttonText,
					' ',
					this.state.showIcon && React__default.createElement(reactFontawesome, { icon: icon })
				),
				React__default.createElement(
					'div',
					{ className: itemClasses, style: styles, onClick: itemsClick },
					this.props.children
				)
			);
		}
...
var Input = function (_Component) {
	...
	createClass$1(Input, [{
		key: 'render',
		value: function render() {
			var classes = ["input", this.state.classes, this.state.state].join(" ");
			var textClass = ["text-", this.state.state].join("");
			var labelClass = ["", this.state.labelClasses].join("");
			return React__default.createElement(
				'label',
...
var List = function (_Component) {
	...
	createClass$1(List, [{
		key: 'render',
		value: function render() {
			var classes = ["list", this.props.classes].join(" ");
...
var ListItem = function (_Component) {
	...
	function ListItem() {
		classCallCheck$1(this, ListItem);
		return possibleConstructorReturn(this, (ListItem.__proto__ || Object.getPrototypeOf(ListItem)).apply(this, arguments));
	}

	createClass$1(ListItem, [{
		key: 'render',
		value: function render() {
			var classes = ["list-item", this.props.classes].join(" ");
			var imageClasses = ["list-item-image text-muted", this.props.imageClasses].join(" ");

			return React__default.createElement(
				'div',
				{ className: classes, onClick: this.props.onClick },
				this.props.icon && React__default.createElement(reactFontawesome, { className: imageClasses, icon: this.props.icon }),
				React__default.createElement(
					'div',
					{ className: 'list-item-content' },
					React__default.createElement(
						'div',
						{ className: "list-item-title " + this.props.titleClasses },
						this.props.title
					),
					this.props.description && React__default.createElement(
						'div',
...
var css$11 = ".modal {\n\tposition: fixed;\n    z-index: -1;\n    width: 100%;\n\theight: 100vh;\n\ttop: 0px;\n\tleft: 0px;\n    opacity: 0;\n    margin-top: -10%;\n    transition: margin .3s, opacity .3s, z-index .4s;\n}\n.modal.from-left {\n\tmargin-top: 0%;\n\tmargin-left: -25%;\n}\n\n.modal.from-right.show {\n    margin-left: 0%;\n}\n.modal.from-right {\n    margin-top: 0%;\n    margin-left: 25%;\n}\n\n.modal.show {\n\toverflow: auto;\n    opacity: 1;\n    margin-top: 0%;\n    z-index: 9999;\n\n\t--root-overflow: hidden;\n    --root-height: 100vh;\n}\n.modal.from-left.show {\n    margin-left: 0%;\n}\n\n.backdrop {\n\tposition: fixed;\n\twidth: 100%;\n\theight: 100%;\n\ttop: 0px;\n\tleft: 0px;\n\tz-index: -1;\n    opacity: 0;\n\tbackground: rgba(0, 0, 0, 0.6) !important;\n\n\ttransition: opacity .4s, z-index .5s;\n}\n\n.backdrop.show {\n    opacity: 1;\n    z-index: 9998;\n}\n\n\n/* phone */\n@media (max-width: 599px) {\n\t.modal.center{\n\t\talign-items: inherit;\n\t}\n}\n\n/* tablet - portrait */\n@media (min-width: 600px) {\n\n}\n\n/* other */\n@media (max-width: 768px) {\n\n}\n\n@media (max-width: 900px) {\n\n}\n\n/* tablet - landscape */\n@media (min-width: 900px) {\n\n}\n\n/* tablet - desktop */\n@media (min-width: 1200px) {\n\n}\n";
styleInject(css$11);
...
var Modal = function (_Component) {
	...
	createClass$1(Modal, [{
		...
		value: function render() {
			...
			var modalClasses = [classes, this.state.classes, show].join(" ");
			var backdropClasses = ["backdrop", show].join(" ");
			return React__default.createElement(
				'div',
				null,
				React__default.createElement(
				...
				React__default.createElement('div', { className: backdropClasses, onClick: this.props.close })
			);
		}
	}]);
	return Modal;
...
var Nav = function (_Component) {
	...
	function Nav(props) {
		...
		var _this = possibleConstructorReturn(this, (Nav.__proto__ || Object.getPrototypeOf(Nav)).call(this, props));
	...
	createClass$1(Nav, [{
		key: 'render',
		value: function render() {
			var classes = ["nav", this.props.classes].join(" ");
			var onClickCallback = this.props.onClickCallback !== undefined ? this.props.onClickCallback : function () {
			...
			return React__default.createElement(
				...
				this.state.links.map(function (link) {
					return React__default.createElement(
						reactRouterDom.NavLink,
						{ key: link.text, to: link.to, onClick: onClickCallback, activeClassName: 'active' },
						link.text
					);
				})
			);
...
var css$15 = ".select {\n\twidth: 100%;\n\tmargin: 5px 0px;\n\tborder: 2px solid var(--card-border-color);\n\tborder-radius: 2px;\n\tpadding: 10px;\n\tfont-size: 16px;\n\tbackground-color: #FFF;\n\tfont-family: inherit;\n\tcolor: var(--text-color);\n\n\t-webkit-appearance: none; \n\t-moz-appearance: none;\n\tappearance: none;\n}\n\n.select-span {\n\tposition: relative;\n\twidth: 100%;\n}\n.select-span .svg-inline--fa.fa-chevron-down {\n\tposition: absolute;\n    right: 10px;\n    top: 20px;\n    color: var(--text-muted);\n    pointer-events: none;\n}\n\n.select.success {\n\tborder-color: var(--success);\n}\n\n.select.information {\n\tborder-color: var(--information);\n}\n\n.select.danger {\n\tborder-color: var(--danger);\n}";
styleInject(css$15);
...
var Select = function (_Component) {
	...
	createClass$1(Select, [{
		key: 'render',
		value: function render() {
			var classes = ["select", this.state.classes, this.state.state].join(" ");
			var textClass = ["text-", this.state.state].join("");
			var labelClass = ["", this.props.labelClasses].join("");
			return React__default.createElement(
				'label',
				{ className: labelClass },
				React__default.createElement(
				...
				React__default.createElement(
					...
					React__default.createElement(
						...
						this.props.options.map(function (option, i) {
							return React__default.createElement(
								'option',
								{ key: option.value + i + "_select", value: option.value },
								option.text
							);
						}, this)
					),
					React__default.createElement(reactFontawesome, { icon: faChevronDown })
				),
				React__default.createElement(
					'span',
					{ className: textClass },
...
var Table = function (_Component) {
	...
	function Table() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Table.__proto__ || Object.getPrototypeOf(Table)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {}, _temp), possibleConstructorReturn(_this, _ret);
	}

	createClass$1(Table, [{
		key: 'render',
		value: function render() {
			var classes = ["table", this.props.classes].join(" ");
			...
			return React__default.createElement(
				'table',
				{ className: classes },
				(this.props.headers && this.props.headers.length > 0 || this.props.title) && React__default.createElement(
					'thead',
					null,
					this.props.title && React__default.createElement(
						...
						React__default.createElement(
							'th',
							{ colSpan: colSpan, key: 'table_header_title_01' },
							this.props.title
						)
					),
					this.props.headers && this.props.headers.length > 0 && React__default.createElement(
						'tr',
						null,
				...
				React__default.createElement(
					...
					this.props.values && this.props.values.map(function (row, index) {
						...
						return React__default.createElement(
							'tr',
							{ key: "table_body_" + index, onClick: function onClick() {
									return _this2.props.onClick ? _this2.props.onClick(index) : _this2.onClick;
								} },
							row.map(function (value, column) {
								return React__default.createElement(
									'td',
									{ key: "table_body_row_" + index + "_" + column },
									value
								);
							})
						);
				...
				this.props.footer && React__default.createElement(
					...
					React__default.createElement(
						...
						React__default.createElement(
							'td',
							{ colSpan: colSpan, key: "table_footer_01" },
							this.props.footer
						)
					)
				)
...
var TextArea = function (_Component) {
	...
	function TextArea(props) {
		classCallCheck$1(this, TextArea);
		...
		_this.state = {
			...
			onChange: props.onChange ? props.onChange : _this.onChange,
			name: props.name ? props.name : ""
		};
		return _this;
	}

	createClass$1(TextArea, [{
		key: 'render',
		value: function render() {
			var classes = ["textarea", this.state.classes, this.state.state].join(" ");
			var textClass = ["text-", this.state.state].join("");
			return React__default.createElement(
				'label',
				null,
...
var Switch = function (_Component) {
	...
	createClass$1(Switch, [{
		key: 'render',
		value: function render() {
			var classes = ["checkbox", this.state.classes, this.state.state].join(" ");
			var textClass = ["text-", this.state.state].join("");
			var labelClass = ["switch ", this.state.labelClasses].join("");
			...
			return React__default.createElement(
				...
				React__default.createElement('input', {
					...
					'data-key': this.props["data-key"],
					'data-value': this.props["data-value"] }),
				React__default.createElement('span', { className: "slider " + shape }),
				React__default.createElement(
					'span',
					{ className: textClass },
					this.state.message
